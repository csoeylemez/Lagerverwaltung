...
class Program
{
    ...
    {
        Console.WriteLine("Bestand anzeigen:");
        foreach (Article article in articles)
        {
            Console.WriteLine($"Name: {article.Name}, Beschreibung: {article.Description}, Preis: {article.Price}, Bestand: {article.Stock}");
        }
    }

    static void SellArticle()
    {
        Console.Write("Artikelname eingeben: ");
        string sellName = Console.ReadLine();

        Article article = articles.FirstOrDefault(a => a.Name == sellName);
        ...
        if (article != null)
        {
            ...
            if (quantity <= article.Stock)
            {
                ...
                Console.WriteLine($"Artikel verkauft. Neuer Bestand: {article.Stock}");
            }
            else
            {
                Console.WriteLine("Nicht genügend Bestand.");
            }
        }
        else
        {
    ...
    static void DeleteArticle()
    {
        ...
        Article article = articles.FirstOrDefault(a => a.Name == deleteName);
...
class Article
{
    ...
    public Article(string name, string description, double price, int stock)
    {
        Name = name;
